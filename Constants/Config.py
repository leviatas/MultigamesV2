...
COMANDOS_JUEGO = {
		...
		"/aportar N - (alternativa por texto) Aportar la carta N de tu mano a un chequeo de Crisis; "
		"en tu turno el bot ya te manda por privado una botonera para elegir y confirmar tus cartas\n"
