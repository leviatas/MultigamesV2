...
#def main():
	...
	app.add_handler(CommandHandler("votar", SecretoCodigoCommands.command_votar))
	app.add_handler(CommandHandler("votarb", SecretoCodigoCommands.command_votarb))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*votebCN\*([0-9]*)\*([0-9]*)", callback=SecretoCodigoCommands.callback_voteb))
	...
	app.add_handler(CommandHandler("saltarpausa", BSGCommands.command_saltar_pausa))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgPrecheckUsar\*(sci|inv)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_precheck_usar))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgPrecheckPasar\*[0-9]*\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_precheck_pasar))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgAportarSel\*([0-9]+)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_aportar_sel))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgAportarContinuar\*[0-9]*\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_aportar_continuar))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgAportarCambiar\*[0-9]*\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_aportar_cambiar))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgAportarOk\*[0-9]*\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_aportar_ok))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgAportarPasar\*[0-9]*\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_aportar_pasar))
	...
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgScoutSP\*x\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_scout_sp))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgScoutMazo\*(crisis|destino)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_scout_mazo))
	...
	app.add_handler(CommandHandler("dar", BSGCommands.command_dar))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgDar\*(-?[0-9]*)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_dar))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgDarTipo\*(mov|acc)_(-?[0-9]*)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_dar_tipo))
	app.add_handler(CommandHandler("bsgadmin", BSGCommands.command_bsgadmin))
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgAdmin\*([a-z_]+)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_admin))
	...
	app.add_handler(CallbackQueryHandler(pattern=r"(-?[0-9]*)\*bsgCrisisTgt\*(none|-?[0-9]+)\*(-?[0-9]*)", callback=BSGCommands.callback_bsg_crisis_target))
